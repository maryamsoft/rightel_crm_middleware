...
def generate_response(cbs_response) :
    ...
    if result_code is not None and result_code.text == '0':
        ...
        response = {
            ...
            "MaximumDepositAmount" : MaximumDepositAmount.text.strip() ,
            "CurrentDepositAmount" : CurrentDepositAmount.text.strip() ,
            "RemainDepositAmount" : RemainDepositAmount.text.strip() ,
        }
        return response
    else:
