...
def destMidVar = destReturn.CreateSubscriberResultMsg.CreateSubscriberResult

def srcMidVar = srcReturn.createSubscriberResultInfo

destMidVar.EffectiveTime = formatDate(srcMidVar.effectiveTime,Constant4Model.DATE_FORMAT)

mappingList(srcMidVar.offeringInst,destMidVar.OfferingInst,listMapping5)

def destMidVar6 = destReturn.CreateSubscriberResultMsg.CreateSubscriberResult.SiteInfo

def srcMidVar6 = srcReturn.createSubscriberResultInfo.siteInfo

destMidVar6.PrimarySite = srcMidVar6.primarySite

destMidVar6.SecondarySite = srcMidVar6.secondarySite

def destMidVar0 = destReturn.CreateSubscriberResultMsg.ResultHeader
