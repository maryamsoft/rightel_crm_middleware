...
def destMidVar = destReturn.AddGroupMemberResultMsg.ResultHeader
...
def destMidVar6 = destReturn.AddGroupMemberResultMsg

listMapping4.call(srcReturn.addMemberResultInfo,destMidVar6.AddGroupMemberResult)
