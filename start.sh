...
nohup /opt/projects/fastapi/crm_middleware/.venv/bin/python -m uvicorn main:app --host 0.0.0.0 --port 8000 --reload &

source /opt/rightel_crm_middleware/.venv/bin/activate
nohup  /opt/rightel_crm_middleware/.venv/bin/uvicorn  main:app --workers 40 --host 0.0.0.0 --port 8000 --loop uvloop --http httptools&
